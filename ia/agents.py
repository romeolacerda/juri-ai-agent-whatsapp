...
from agno.models.openai import OpenAIChat  # ADICIONE ESTA IMPORTAÇÃO
...
class JuriAI:
    ...
    def build_agent(cls, knowledge_filters: dict = {}) -> Agent:
        ...
        # CONFIGURE O MODELO COM TIMEOUT
        model = OpenAIChat(
            id="gpt-4o",
        ...
        return Agent(
            ...
            model=model,  # ADICIONE O MODELO AQUI
...
class SecretariaAI:
    CREDENTIALS_PATH = settings.BASE_DIR / "client_secret_398182962398-47kc3n9gt062hh85fahbkhufhfdkn8ea.apps.googleusercontent.com.json"
